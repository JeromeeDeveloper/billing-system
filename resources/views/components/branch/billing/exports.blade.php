                            ...
                            <div class="card-body">
                                ...
                                @if($exports->isEmpty())
                                    <div class="text-center py-5">
                                        <p class="text-muted mb-0">No export history available for your branch.</p>
                                        <small class="text-muted">Only exports generated by users from your branch are displayed here.</small>
                                    </div>
                                @else
