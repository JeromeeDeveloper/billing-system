...
<body>
            ...
            <div class="container-fluid">
                <div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="{{ route('master.branch') }}">Master List</a></li>
                        </ol>
                    </div>
                </div>
                <!-- Export Button -->
                ...
                <div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="addModalLabel"
                    ...
                    <div class="modal-dialog modal-xl">
                        <form action="{{ route('members.store.branch') }}" method="POST">
                            @csrf
    ...
    <div class="loan-item border p-3 mb-3 rounded position-relative">
        ...
        $('#deleteModal').on('show.bs.modal', function(event) {
            ...
            $('#deleteForm').attr('action', '/Branch/master/members/' + id);
        });
    </script>
    ...
    <script>
        ...
        function applyBulkEdit() {
            ...
            $.ajax({
                url: `/Branch/master/members/${memberId}`,
                method: 'POST',
                data: formData,
                processData: false,
                contentType: false,
