                                            ...
                                            <div class="row">
                                                @foreach ($branches as $index => $branch)
                                                    @php
                                                        ...
                                                        $percentage =
                                                            $totalMembers > 0
                                                                ? round(($memberCount / $totalMembers) * 100, 1)
                                                                : 0;
                                                        $colors = ['#593bdb'];
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="text-right">
                                                                        <h3 class="mb-0 font-weight-bold"
                                                                            style="color: {{ $color }}">
                                                                            {{ number_format($memberCount) }}</h3>
                                                                        <small class="text-muted">Members</small>
                                                                    </div>
                                                                </div>

                                                                <div class="progress mb-2"
                                                                    style="height: 8px; background-color: #f8f9fa;">
                                                    ...
                                                    <div class="card border-0 shadow-sm"
                                                        ...
                                                        <div class="card-body p-4 text-white">
                                                            <div class="row align-items-center">
                                                                <div class="col-md-8">
                                                                    <h4 class="mb-2 font-weight-bold">Total Overview
                                                                    </h4>
                                                                    <p class="mb-0 opacity-75">Across all
                                                                        {{ count($branches) }} branches</p>
                                                                </div>
                                                                <div class="col-md-4 text-right">
                                                                    <h2 class="mb-0 font-weight-bold">
                                                                        {{ number_format($totalMembers) }}</h2>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="alert alert-info alert-dismissible fade show mb-4">
                                    ...
                                    <p class="mb-2 text-dark">You can manually close the current billing period and
                                        move all users to the next period. This is useful if remittances are late or you
                                        want to control the period closing date.</p>
                                    <form method="POST" action="{{ route('billing.close-period') }}"
                                        id="closePeriodForm">
                                        @csrf
                                        <button type="button" class="btn btn-danger mt-2" data-toggle="modal"
                                            data-target="#closePeriodModal">
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header bg-primary text-white">
                                <h5 class="modal-title text-white" id="closePeriodModalLabel"><i
                                        class="fa fa-exclamation-triangle"></i> Close Billing Period Confirmation</h5>
                            ...
                            <div class="modal-body">
                                <div class="text-center">
                                    ...
                                    <div class="alert text-dark mb-4">
                                        <h6 class="alert-heading text-dark"><i class="fa fa-calendar"></i> Current
                                            Billing Period</h6>
                                    ...
                                    <div class="alert text-dark mb-4">
                                        <h6 class="alert-heading text-dark"><i class="fa fa-calendar-plus"></i> Next
                                            Billing Period</h6>
                                        <h4 class="text-dark mb-0">
                                    ...
                                    <div class="alert text-dark">
                                        <h6 class="alert-heading text-danger"><i
                                                class="fa fa-exclamation-triangle"></i> Important Warnings</h6>
                                        <ul class="text-center mb-0 text-dark">
                                            <li><strong>This will close the current billing period for <span
                                                        class="text-danger">ALL USERS</span></strong></li>
                                            <li><strong>All users will be moved to the next billing period</strong></li>
                                            <li><strong>This action cannot be undone</strong></li>
                                            <li><strong>Late remittances or unfinished tasks will be <span
                                                        class="text-danger">LOCKED OUT</span></strong></li>
                                        </ul>
                                    </div>

                                    <p class="text-danger font-weight-bold mt-3">Please double-check with your team
                                        before proceeding.</p>
                                </div>
                            </div>
                        ...
                        .then(data => {
                            if (data.success) {
                                ...
                                Swal.fire({
                                    ...
                                    text: data.message ||
                                        'An error occurred while closing the billing period.',
